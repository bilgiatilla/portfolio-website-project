  ...
  return (
    <footer className="bg-[#f5f5f5]]  py-8 px-6 text-center">
      ...
      <a
        ...
        className="text-[#4731D3] dark:text-[#ffbc42] underline text-lg font-medium block mb-6"
      >
        atillabilgi.ab@gmail.com
      </a>
      <div className="flex justify-center gap-6 text-xl text-[#4731D3] dark:text-[#ffbc42]">
